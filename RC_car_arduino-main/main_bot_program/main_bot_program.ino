...
//sharpLeft turn movement for the BOT.
void sharLeftTurn() {
  analogWrite(enableMotorA, maxSpeedCount);
  analogWrite(enableMotorB, maxSpeedCount);
  digitalWrite(in1, LOW);
...
//sharpRight turn movement for the BOT.
void sharpRightTurn() {
  analogWrite(enableMotorA, maxSpeedCount);
  analogWrite(enableMotorB, maxSpeedCount);
  digitalWrite(in1, HIGH);
